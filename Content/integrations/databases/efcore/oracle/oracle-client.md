...
To get started with the Aspire Oracle integrations, follow the [Get started with Oracle integrations](/integrations/databases/efcore/oracle/oracle-get-started) guide.
</IntegrationIcon>
...
> [!TIP]
> The `connectionName` parameter must match the name used when adding the Oracle database resource in the AppHost project. For more information, see [Add Oracle server and database resources](/integrations/databases/efcore/oracle/oracle-host/#add-oracle-server-and-database-resources).
...
> [!NOTE]
> The connection string name that you pass to the `GetConnectionString` method must match the name used when adding the Oracle resource in the AppHost project. For more information, see [Add Oracle server and database resources](/integrations/databases/efcore/oracle/oracle-host/#add-oracle-server-and-database-resources).
