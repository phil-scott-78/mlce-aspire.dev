...
Hosting integrations extend the `IDistributedApplicationBuilder` interface to enable the _app host_ project to express resources within its [_app model_](/docs/architecture/overview/#app-model-architecture). Key characteristics include:
