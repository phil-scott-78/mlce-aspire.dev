...
<Steps>
<Step stepNumber="1">
**Annotation-based registration**: Resources use annotations to declare their pipeline steps

</Step>
<Step stepNumber="2">
**Automatic discovery**: The pipeline system automatically discovers steps from all resources during the registration phase

</Step>
<Step stepNumber="3">
**Dependency integration**: Resource steps can depend on well-known steps or other resource steps
...
<Steps>
<Step stepNumber="1">
**Building site artifacts**: Compile, optimize, and prepare static files

</Step>
<Step stepNumber="2">
**Configuring storage permissions**: Set up appropriate access controls

</Step>
<Step stepNumber="3">
**Uploading files**: Transfer built artifacts to cloud storage

</Step>
<Step stepNumber="4">
**Configuring CDN**: Set up content distribution and routing
...
<Steps>
<Step stepNumber="1">
**Includes all dependencies**: Ensures prerequisite steps are executed in the correct order

</Step>
<Step stepNumber="2">
**Skips unnecessary steps**: Avoids running steps that aren't required for your target step

</Step>
<Step stepNumber="3">
**Maintains consistency**: Validates that the deployment state remains coherent
...
<Steps>
<Step stepNumber="1">
**Immediate failure detection**: Failed steps are identified and reported quickly without waiting for unrelated operations to complete

</Step>
<Step stepNumber="2">
**Smart dependency cascade prevention**: When a step fails, only its dependent steps are cancelled, allowing unrelated operations to continue

</Step>
<Step stepNumber="3">
**Partial success preservation**: Successfully completed steps maintain their state and don't need to be repeated during retry operations

</Step>
<Step stepNumber="4">
**Error isolation**: Failures in one part of the pipeline are contained and don't affect independent operations
