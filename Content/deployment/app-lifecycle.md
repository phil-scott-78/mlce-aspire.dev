...
<Step stepNumber="2">
**Local Deployment** - Deployment to your defined compute environment(s) with `aspire deploy`. This example shows containerized deployment to Docker Desktop.

</Step>
<Step stepNumber="3">
**Publish Release (CI/CD)** - Automated build & publish pipeline. This example shows using GitHub Actions to build and push images and publish release artifacts for deployment later.
...
For more information, see [AppHost configuration](/docs/app-host/configuration/configuration).

## Next steps

- Learn more about [Service discovery](/docs/fundamentals/services-and-networking/service-discovery)
- Explore [Telemetry](/docs/fundamentals/observability/telemetry) options
- Understand [Health checks](/docs/fundamentals/observability/health-checks)
