...
<Steps>
<Step stepNumber="1">
Open your Aspire solution in a supported version of Visual Studio or VS Code with the C# Dev Kit extension installed.

</Step>
<Step stepNumber="2">
Ensure you're logged into the IDE with a GitHub account:
...
<!-- Image: A screenshot of the dashboard with the GitHub Copilot button highlighted. -->
...
<!-- Image: A screenshot of the dashboard with GitHub Copilot open. It contains a chat question and answer. -->
...
<!-- Image: A screenshot of the Ask GitHub Copilot option in the resource context menu page. -->
...
<!-- Image: A screenshot of the structured logs page with an Explain errors button. -->
...
<!-- Image: A screenshot of the trace details page with an Explain trace button. -->
