...
<!-- Image: Aspire dashboard login page with instructions on how to obtain the token. -->

After copying the token from the console and pasting it into the login page, select the **Log in** button.

<!-- Image: Aspire dashboard login page with the token pasted into the textbox. -->
...
<!-- Image: A screenshot of the Aspire dashboard Resources page. -->
...
<!-- Image: A screenshot of the Aspire dashboard Resources page in graph view. -->
...
<!-- Image: Aspire dashboard stop resource. -->
...
<!-- Image: Aspire dashboard resource stopped. -->
...
<!-- Image: Aspire dashboard started resource. -->
...
> 
> <!-- Image: Aspire dashboard disabled submenu actions. -->
> 
...
<!-- Image: A screenshot of the Aspire dashboard Resources page, showing the ellipsis menu options. -->
...
<!-- Image: A screenshot of the Aspire dashboard Resources page, showing the text visualizer. -->
...
<!-- Image: A screenshot of the Aspire dashboard Resources page with the details of a selected resource displayed. -->
...
<!-- Image: A screenshot of the resource type selector list in the Aspire dashboard Resources page. -->
...
<!-- Image: A screenshot of the Aspire dashboard Resources page filtered to show only containers. -->
...
<!-- Image: A screenshot of the Aspire dashboard Resources page, showing a project with errors. -->
...
<!-- Image: A screenshot of the Aspire dashboard Structured logs page, showing a filter applied to show only the logs relevant to the resource. -->
...
<!-- Image: A screenshot of the Aspire dashboard Structured logs page, showing a lower window with the structured log entry details. -->
...
<!-- Image: A screenshot of the Aspire dashboard Console Logs page with a source selected. -->
...
<!-- Image: A screenshot of the Aspire dashboard Console Logs page, showing logs with errors. -->
...
<!-- Image: A screenshot of the Aspire dashboard Console logs page with a container source selected. -->

You can download any console log to your local machine and use your preferred text programs to analyze it:

<!-- Image: A screenshot of the Aspire dashboard Console logs page showing how to download a log to your local machine. -->
...
<!-- Image: Aspire dashboard: Console logs page resource selector with nested replica resources. -->
...
<!-- Image: A screenshot of the Aspire dashboard Semantic logs page. -->
...
<!-- Image: A screenshot of the Aspire dashboard Structured logs page showing the filter dialog. -->
...
<!-- Image: A screenshot of the Aspire dashboard Traces page. -->
...
<!-- Image: A screenshot of the Aspire dashboard Traces page, showing a filter applied to show only traces with the term 'weather'. -->
...
<!-- Image: A screenshot of the Aspire dashboard Traces page, showing the Add filter dialog with the http.route parameter selected. -->
...
<!-- Image: Filter by all instances of a resource -->
...
<!-- Image: A screenshot of the Aspire dashboard Structured logs page, showing a filter applied to show only the logs relevant to the trace. -->
...
<!-- Image: A screenshot of the Aspire dashboard Trace details page. -->

For each span in the trace, select **View details** to see more details:

<!-- Image: A screenshot of the Aspire dashboard Trace details page with the details of a span displayed. -->
...
<!-- Image: A screenshot of the Aspire dashboard Trace details page with the event timings for a span displayed. -->

For complex traces with many spans, use the **Filter** textbox to display only matching spans:

<!-- Image: A screenshot of the Aspire dashboard Trace details page with the filter used to display only weather spans. -->
...
<!-- Image: A screenshot of the Aspire dashboard Traces page, showing traces with errors. -->

And the corresponding detailed view of the trace with errors:

<!-- Image: A screenshot of the Aspire dashboard Trace details page, showing a trace with errors. -->
...
<!-- Image: A screenshot of the Aspire dashboard Metrics page. -->
...
<!-- Image: A screenshot of the Aspire dashboard Metrics page with the table view selected. -->
...
<!-- Image: A screenshot of the Aspire dashboard Metrics page with a filter applied to the chart. -->

You can also choose to select the count of the displayed metric on the vertical access, instead of its values:

<!-- Image: A screenshot of the Aspire dashboard Metrics page with the count option applied. -->
...
<!-- Image: Aspire Dashboard: Metrics Page, with exemplar indicator hover details. -->
...
<!-- Image: Aspire Dashboard: Trace Page, navigated to from the corresponding Metrics Page exemplar. -->
...
<!-- Image: A screenshot of the Aspire dashboard Console logs page, showing how to pause telemetry. -->
...
<!-- Image: A screenshot of the Aspire dashboard Structured logs page, showing how to remove telemetry. -->
...
<!-- Image: A screenshot of the Aspire dashboard Settings dialog, showing the Manage button under Resource logs and telemetry. -->
...
<!-- Image: A screenshot of the Aspire dashboard Manage logs and telemetry dialog, showing a resource expanded to display individual data types. -->
...
<!-- Image: A screenshot of the Aspire dashboard Manage logs and telemetry dialog, showing resources with available data types and export, remove, and import buttons. -->
...
<!-- Image: The Aspire dashboard Settings dialog, showing the System theme default selection. -->

If you prefer the Light theme, you can select it from the theme selection dialog:

<!-- Image: The Aspire dashboard Settings dialog, showing the Light theme selection. -->

## Dashboard shortcuts

The Aspire dashboard provides various shortcuts to _help_ you navigate and control different parts of the dashboard. To display the keyboard shortcuts, press , or select the question mark icon in the top-right corner of the dashboard:

<!-- Image: Aspire dashboard Help modal dialog. -->
...
- : Increase panel size.
- : Decrease panel size.
- : <u>R</u>eset panel size.
- : <u>T</u>oggle panel orientation.
- : Close panel.

**Page navigation**:

- : Go to **<u>R</u>esources**.
- : Go to **<u>C</u>onsole Logs**.
- : Go to **<u>S</u>tructured Logs**.
- : Go to **<u>T</u>races**.
- : Go to **<u>M</u>etrics**.
