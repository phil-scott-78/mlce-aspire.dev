...
Aspire 9 makes it simpler to configure your environment to develop Aspire applications. You no longer need a .NET workload. Instead, you install the new [Aspire SDK](/docs/app-host/project-structure/aspire-sdk) into the AppHost project of your Aspire solutions. For more information, see [Aspire setup and tooling](/docs/get-started/setup-and-tooling/prerequisites).
...
![Colorful console logs](/assets/whats-new/aspire-9/console-logs-ansi-text-format.png)
...
[Telemetry](/docs/fundamentals/observability/telemetry) remains a vital aspect of Aspire. In Aspire 9, many new features were introduced to the Telemetry service.
...
![Trace detail page with browser telemetry](/assets/whats-new/aspire-9/dashboard-browser-telemetry.png)
...
The [Aspire AppHost](/docs/fundamentals/core-concepts/app-host) is one of the **most important** features of Aspire. In Aspire 9, several new features were added specific to the AppHost.
...
For more information, see [Aspire AppHost: Waiting for resources](/docs/fundamentals/core-concepts/app-host/#adding-an-api-resource-and-declaring-a-dependency).

#### Resource health checks

The `WaitFor` API uses standard [.NET health checks](/docs/fundamentals/observability/health-checks) to determine if a resource is ready. But what does "a resource being ready" mean? The best part is, that's configurable by the consumer beyond their default values.
...
![Waiting for an unhealthy resource before starting](/assets/whats-new/aspire-9/waiting-for-unhealthy-resource.png)
...
![Health check details in the dashboard's resource details view](/assets/whats-new/aspire-9/health-check-details.png)
...
![Persistent containers](/assets/whats-new/aspire-9/persistent-container.png)

After the AppHost is stopped, the container will continue to run:

![Docker desktop showing RabbitMQ](/assets/whats-new/aspire-9/persistent-container-docker-desktop.png)
...
For more information on creating custom resource commands, see [How-to: Create custom resource commands in Aspire](/docs/extensibility/custom-resource-commands).
...
The global events are analogous to the AppHost life cycle events. For more information, see [AppHost life cycles](/docs/app-host/eventing/#apphost-eventing).
...
For more information, see [Eventing in Aspire](/docs/app-host/eventing).
...
![Redis Insight dashboard showing multiple Redis instances](/assets/whats-new/aspire-9/redis-insight.png)
...
![Create new Aspire Azure Functions project](/assets/whats-new/aspire-9/functions-step-1.gif)
...
![Screenshot of the Aspire running with an Azure Function app](/assets/whats-new/aspire-9/functions-dashboard-screenshot.png)
...
![Screenshot of the Aspire dashboard: Debugging an Azure Function app](/assets/whats-new/aspire-9/functions-debug-screenshot.png)
