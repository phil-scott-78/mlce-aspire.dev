...
![Recording of aspire update running on eShop sample.](/assets/whats-new/aspire-9.5/aspire-update.gif)
...
For more information, see [aspire config set command](/reference/cli/commands/aspire-config-set).
...
For more information, see the aspire exec command reference.
...
![Recording of the GenAI visualizer.](/assets/dashboard/explore/dashboard-geni-visualizer.gif)
...
![Screenshot of property grid with icons.](/assets/whats-new/aspire-9.5/dashboard-rich-property-grid.png)
...
![Screenshot of the console logs page displaying (All) logs.](/assets/whats-new/aspire-9.5/console-logs-all.png)
...
![Screenshot of the dashboard showing the container runtime warning.](/assets/whats-new/aspire-9.5/dashboard-container-warning.png)
...
![Screenshot of the traces page showing the type filter.](/assets/whats-new/aspire-9.5/dashboard-trace-type.png)
...
![Screenshot of trace details showing the new resources column and log tooltips.](/assets/whats-new/aspire-9.5/dashboard-trace-detail-logs.png)
