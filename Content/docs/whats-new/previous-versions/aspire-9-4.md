...
The Aspire CLI has the following [commands](/reference/cli/commands/aspire):
...
In addition to these core commands, we have two beta commands behind [feature flags](/reference/cli/commands/aspire-config):
...
> [!NOTE]
> The `aspire exec` command is disabled by default. To use it, turn on the feature toggle by running:
>
> ```bash title='Aspire CLI'
> aspire config set features.execCommandEnabled true
> ```
>
> For more information, see [aspire config command](/reference/cli/commands/aspire-config).
...
For more information about publishing and deploying Aspire apps, see [aspire deploy](/reference/cli/commands/aspire-deploy).
...
![Recording of using the interaction service in the dashboard.](/assets/whats-new/aspire-9.4/dashboard-interaction-service.gif)
...
Modern applications frequently need to integrate with external APIs, third-party services, or existing infrastructure that isn't managed by Aspire. Aspire 9.4 introduces first-class support for [modeling external services](/docs/fundamentals/core-concepts/resources) as resources in your application graph.
...
![Screenshot of dashboard showing an update notification.](/assets/whats-new/aspire-9.4/dashboard-update-notification.png)
...
![Screenshot of dashboard showing connection string.](/assets/whats-new/aspire-9.4/dashboard-connection-strings.png)

External parameters are no longer hidden. The parameter state and value is visible in the dashboard.

![Screenshot of dashboard showing parameters.](/assets/whats-new/aspire-9.4/dashboard-parameters.png)

For more information, see [external parameters](/docs/fundamentals/configuration/external-parameters).
...
![Screenshot of a span linked to a GitHub model resource defined in Aspire.](/assets/whats-new/aspire-9.4/dashboard-tracing-peers.png)
...
![Recording of toggling line wrapping on console logs page.](/assets/whats-new/aspire-9.4/dashboard-console-logs-wrapping.gif)
...
![Dashboard resources page with the show/hide hidden resources UI visible.](/assets/whats-new/aspire-9.4/dashboard-hidden-resources.png)
