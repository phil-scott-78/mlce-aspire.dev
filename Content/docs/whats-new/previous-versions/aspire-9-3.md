...
![Screenshot of dashboard with GitHub Copilot chat open.](/assets/whats-new/aspire-9.3/dashboard-copilot.png)
...
![Screenshot of dashboard resource's page showing the filter popup.](/assets/whats-new/aspire-9.3/dashboard-filter.png)
...
![Screenshot of dashboard traces's page showing added resources in results.](/assets/whats-new/aspire-9.3/dashboard-traces-uninstrumented-resources.png)
...
![Screenshot of dashboard resource graph view with a context menu.](/assets/whats-new/aspire-9.3/dashboard-context-menu.png)
...
![Screenshot of dashboard metrics page with a pause warning.](/assets/whats-new/aspire-9.3/dashboard-metrics-warning.png)
