...
- [Add Dockerfiles to your app model](/docs/app-host/resource-types/withdockerfile)
- [Persistent container lifetimes](/docs/app-host/resource-types/persistent-containers)
