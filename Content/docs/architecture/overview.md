...
In run mode, [the AppHost orchestrates](/docs/fundamentals/core-concepts/app-host) all resources defined in your app model. But how does it achieve this?
...
- Monitors resources:
  - Provides change notifications about objects managed within DCP, including process IDs, running status, and exit codes (the AppHost subscribes to these changes to manage the [application's lifecycle](/docs/app-host/eventing) effectively).
