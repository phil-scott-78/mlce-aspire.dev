...
In this tutorial, you take the app you created in the [Build your first Aspire app](/docs/get-started/first-app) quickstart and deploy it. This can be broken down into several key steps:
